...
module.exports = {
    ...
    // API Points
    defaultHost: 'https://deviceserver.creatordev.io',
    defaultAuthEndpoint: '/oauth/token',

    // Error Messages
    INVALID_KEYS_ERROR: 'Client requires valid access key and secret to be set explcitly or via the CREATOR_ACCESS_KEY and CREATOR_ACCESS_SECRET environment variables.',
